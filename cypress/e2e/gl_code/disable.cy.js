describe('Session Login ',()=>{
   beforeEach(() => {
        ...
        cy.fixture(`data/${data_path}/gl_code/disable/data`).then(function (data) {
           this.data = data;
        })
     })
    describe("To verify Disable button functionality.", function () {
      it('FC-2216 Disable GL code <smoke>', function () { 
