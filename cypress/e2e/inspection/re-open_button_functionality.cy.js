describe('Session Login ',()=>{
    ...
    describe("Re-Open Button in Inspection Summary Page",function (){
        it("FC-4540 To Verify Re-Open Button Functionality.",function (){
            ...
            cy.execute('script/inspection/re-open_button_functionality',this.data);
        });
    });
});
