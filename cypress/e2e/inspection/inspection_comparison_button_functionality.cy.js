describe('Session Login ',()=>{
    ...
    describe("Inspection Comprison Button Functionality in Inspections Page", function() {
        it('FC-5441 To Verify "Inspection Comparison" Button Functionality <smoke>', function() {
            ...
            cy.wait(5000);
            cy.select_by_calendar_using_label('Date To',this.data.date_to);
            cy.wait(3000);
