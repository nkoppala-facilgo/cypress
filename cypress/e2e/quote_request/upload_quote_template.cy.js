...
//     it("create a quote request with Registered Supplier and upload template on supplier side <smoke>", function () {
...
//       cy.select_by_label('Quote Request Title(s):',this.data['title']);
...
//       }
//       cy.get('body').contains('Type here...').type(generateString(10), {force: true});
