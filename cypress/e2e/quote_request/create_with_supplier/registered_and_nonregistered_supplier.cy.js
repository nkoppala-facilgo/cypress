describe("Session Login ", () => {
  beforeEach(() => {
    ...
    cy.fixture(`data/${data_path}/quote_request/create/reg_nonreg/data`).then(
      function (data) {
        this.data = data;
      }
    );
  });
  describe("Create a quote request with Registered as well as with Non-Registered Supplier", function () {
    it("fc-1416 create a quote request with Registered as well as with Non-Registered Supplier <smoke>", function () {
