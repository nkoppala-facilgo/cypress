describe('Session Login ',()=>{
    beforeEach(() => {
        ...
        cy.fixture(`data/${data_path}/order/catalog_order_shopping/data`).then(function(data) {
            this.catalog_order_shopping_data = data;
        })
    }) 
    describe(" Order ", function() {
        it('FC-2200 catalog new Orders  <smoke>', function() {
            cy.visit()
            cy.wait(3000)
            ...
            cy.execute('script/order/catalog_order_shopping', this.catalog_order_shopping_data)
        });
    });
});