describe('Session Login ',()=>{
        ...
        describe("Reject order cancellation ", function() {
            it('fc-4392 verifying void button  <smoke>', function() {
                cy.visit()
                cy.wait(3000)
            ...
            it('Reject order Cancellation from Supplier side at Work order hierarchy table <smoke>', function() {
                var data_path = Cypress.env(`data`);
    cy.fixture(`data/${data_path}/login/data`).then(function (data) {
      cy.login_with_session(data.supplier.username, data.supplier.password);
       ...
       cy.execute('script/order/supplier/path_to_order',this.data)
                ...
                cy.execute('script/order/supplier/reject_from_hierarchy_table',this.data) 
            });
        });
    });