describe('Session Login ',()=>{
   ...
   cy.fixture(`data/${data_path}/property/enable/data`).then(function (data) {
      this.data = data;
   })
})
describe("To verify that user is able to enable property.", function () {
 it('FC-2226 To verify that user is able to enable property.  ', function () { 
...
cy.get('.property_property_code input[name=\"property[property_code]\"]').type(ans1);
      ...
      cy.wait(5000)
      cy.execute('/script/property/enable',this.data)
  });
});
});
