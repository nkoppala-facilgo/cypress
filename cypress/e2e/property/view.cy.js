describe('Session Login ',()=>{
   ...
   cy.fixture(`data/${data_path}/property/view/data`).then(function (data) {
      this.data = data;
   })
})
describe("To verify that user is able to view property on property view page.", function () {
 it('FC-2225 To verify that user is able to view property on property view page.  ', function () { 
