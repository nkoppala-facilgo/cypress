describe('Session Login ',()=>{
  ...
  cy.fixture(`data/${data_path}/work_order/create_qr_from_wo/pricelist_type_quote/data`).then(function (data) {
    this.data1 = data;
  });
});
describe("Create qr from workorder pricelist-type <smoke>", function () {
  it('FC-2861 Supplier Side- Create Quote from QR (Quote- Price List type) ', function () { 
    cy.visit();
