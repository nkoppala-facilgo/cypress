describe("Session Login ", () => {
    ...
    describe("To verify 'Do not include overlay asset group’ checkbox is checked on 'Form Exception' pop up when company setting set as checked", function () {
        it("FC-9032 Do not include overlay asset group checkbox is checked on Form Exception pop up when company setting set as checked <regression>", function () {
            cy.visit();
            cy.wait(3000);
            ...
            cy.get("#company_company_setting_attributes_exclude_overlay_asset_groups_on_inv_form_exception_default_flag").select("Checked");
