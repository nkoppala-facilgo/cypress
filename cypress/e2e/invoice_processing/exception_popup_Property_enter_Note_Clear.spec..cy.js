describe("Session Login ", () => {
  ...
  describe("To verify 'property' field is appeared on 'Form Exceptions' pop up", function () {
    it("FC-7131 FC-7130 To verify user is able to search properties on 'Form Exception' pop up <smoke>", function () {
      cy.visit();
