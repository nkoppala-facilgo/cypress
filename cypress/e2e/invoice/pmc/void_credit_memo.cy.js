describe('Session Login ',()=>{
        ...
        describe("To verify that PMC is able to Void the Credit memos", function() {
                it('FC-2100 void a new credit memo  <smoke>', function() {
                        cy.visit()
               ...
               return common_str + result;
                        ...
                        .then(finvoice => {
                                ...
                                cy.contains("Credit Memo was successfully created.").should('exist')
